...
public class RecyclerViewSubNewsAdapter extends  RecyclerView.Adapter<RecyclerViewSubNewsAdapter.ViewHolder>{

    ArrayList<NewsModel> models;
    Context context;

    public RecyclerViewSubNewsAdapter(ArrayList<NewsModel> models, Context context) {
        this.models = models;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_news_subheadline, parent, false);
