...
public class RecyclerViewPopularAdapter extends RecyclerView.Adapter<RecyclerViewPopularAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        ImageView imageView;
        RecyclerViewPopularAdapter.OnItemClickListener onItemClickListener;

        public MyViewHolder(@NonNull View itemView, RecyclerViewPopularAdapter.OnItemClickListener onItemClickListener) {
            super(itemView);
