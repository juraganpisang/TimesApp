...
public class RecyclerViewVideoAdapter extends RecyclerView.Adapter<RecyclerViewVideoAdapter.MyViewHolder> {
    ...
    public RecyclerViewVideoAdapter(List<DataModel> dataModels, Context context) {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        private RecyclerViewVideoAdapter.OnItemClickListener onItemClickListener;

        public MyViewHolder(@NonNull View itemView, RecyclerViewVideoAdapter.OnItemClickListener onItemClickListener) {
            super(itemView);
