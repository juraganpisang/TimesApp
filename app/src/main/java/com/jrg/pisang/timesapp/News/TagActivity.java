...
public class TagActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener  {
    ...
    private void initListenerPopular() {
        recyclerViewNewsAdapter.setOnItemClickListener(new RecyclerViewNewsAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                Intent intent = new Intent(TagActivity.this, DetailNewsActivity.class);
    ...
    public void loadJSON() {
        ...
        callPopular = apiInterface.getListTag(key, "tag", mTag, 0, 30);
        callPopular.enqueue(new Callback<HeadlineModel>() {
            ...
            public void onResponse(Call<HeadlineModel> call, Response<HeadlineModel> response) {
                if (response.isSuccessful() && response.body().getData() != null) {
                    ...
                    appbar_title.setText(mTag.toUpperCase());
